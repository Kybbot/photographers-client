import React, { ChangeEvent, Dispatch, FC, memo, SetStateAction, useMemo, useRef, useState } from "react";
...
export const PhoneNumberSelect: FC<PhoneNumberSelectProps> = memo(
	({ closeModal, setCurrentCountry, setPhone, setSelectState }) => {
